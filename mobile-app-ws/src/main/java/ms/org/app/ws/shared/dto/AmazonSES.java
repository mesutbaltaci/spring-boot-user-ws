package ms.org.app.ws.shared.dto;
...
public class AmazonSES {
	...
	// This address must be verified with Amazon SES.
		final String FROM = "mesutbaltaci@hotmail.com";

		// The subject line for the email.
		final String SUBJECT = "One last step to complete your registration with MyAPP";
		
		final String PASSWORD_RESET_SUBJECT = "Password reset request";

		// The HTML body for the email.
		final String HTMLBODY = "<h1>Please verify your email address</h1>"
				+ "<p>Thank you for registering with our my app. To complete registration process and be able to log in,"
				+ " click on the following link: "
				+ "<a href='http://ec2-54-172-42-172.compute-1.amazonaws.com:8080/verification-service/email-verification.html?token=$tokenValue'>"
		...
		final String TEXTBODY = "Please verify your email address. "
				...
				+ " http://ec2-54-172-42-172.compute-1.amazonaws.com:8080/verification-service/email-verification.html?token=$tokenValue"
				+ " Thank you! And we are waiting for you inside!";
